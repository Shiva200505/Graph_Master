...
export default function DealerLoginPage() {
    ...
    return (
        <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #3D1A54 0%, #6B2D7A 100%)' }}>
            <div style={{ width: '100%', maxWidth: '400px', padding: '0 1rem' }}>
                <div style={{ background: 'white', borderRadius: '20px', padding: '2.5rem', boxShadow: '0 25px 60px rgba(0,0,0,0.35)' }}>
                    ...
                    <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
                        ...
                        <div style={{ fontWeight: 900, fontSize: '1.4rem', letterSpacing: '-0.04em', color: '#1e1230' }}>
                            Grape<span style={{ color: '#6B2D7A' }}>Master</span>
                        </div>
                    ...
                    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                        <div>
                            <label className="input-label">Dealer Email</label>
                            <input
                                className="input"
                                type="email"
                        ...
                        <button
                            ...
                            style={{
                                ...
                                background: loading ? '#ccc' : 'linear-gradient(135deg, #4a1f65, #6B2D7A)',
                        ...
                        >
                            ...
                            {loading ? 'Signing in...' : 'Sign In to Dealer Panel'}
                        </button>
                    </form>
                ...
                <div style={{ textAlign: 'center', marginTop: '1rem', color: 'rgba(255,255,255,0.35)', fontSize: '0.75rem' }}>
                    Authorized Dealers Only · Contact admin for access
                </div>
            </div>
        </div>
    );
